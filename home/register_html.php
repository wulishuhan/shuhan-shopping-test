...
<table class="reg" style="margin: 150px auto; background: none; color: white; opacity: 0.7; border-radius: 20px; border: solid 2px white;">
	<tr><td class="title" colspan="2">欢迎注册新用户</td></tr>
	<tr><th>用户名：</th><td><input type="text" name="username" style="background: none;"/></td></tr>
	<tr><th>邮箱：</th><td><input type="text" name="email" style="background: none;"/></td></tr>
	<tr><th>密码：</th><td><input type="password" name="password" id="pw1" style="background: none;"/></td></tr>
	<tr><th>确认密码：</th><td><input type="password" id="pw2" style="background: none;"/></td></tr>
	<tr><td colspan="2" class="td-btn">
	<input type="submit" value="提交注册" class="button" style="background: none;border: solid 1px white;"/>
	<input type="button" value="返回登录" class="button" onclick="location.href='login.php'"  style="background: none;border: solid 1px white;"/>
	</td></tr>
</table>
</form>
<?php if(!empty($error)): ?>
